...
public class Kuningan extends javax.swing.JFrame {

    public Kuningan() {
        initComponents();
        setDefaultCloseOperation(Ambassador.DISPOSE_ON_CLOSE);
        updateTable("Select * from holly_registration.itc");
    }
...
//Performing the Registration    
    private void RegisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisActionPerformed
        ...
        String branch = "ITC Kuningan";

        Regis r = new Regis();
        r.regisAction(name, mobile, gender, ranks, dob, branch, "itc");
    ...
    private void EditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseClicked
        ...
        Edit e = new Edit();
        e.editAction(name, mobile, gender, ranks, dob, id, "itc");
    ...
    private void group_txtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_group_txtActionPerformed
        ...
        {
         String select = "Select * from holly_registration.itc WHERE Ranks = \"Staff\"";
         updateTable(select);
        }
        else if(group == "Member")
        {
         String select = "Select * from holly_registration.itc WHERE Ranks = \"Customer\"";
         updateTable(select);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kuningan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
