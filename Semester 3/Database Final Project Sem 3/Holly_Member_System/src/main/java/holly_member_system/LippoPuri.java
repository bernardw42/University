...
public class LippoPuri extends javax.swing.JFrame {

    public LippoPuri() {
        initComponents();
        setDefaultCloseOperation(Ambassador.DISPOSE_ON_CLOSE);
        updateTable("Select * from holly_registration.puri");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lippo Mall Puri");
...
//Printing out to display
    private void updateTable(String select){
        ...
        try {
            ...
            Logger.getLogger(LippoPuri.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//Performing the Registration    
    private void RegisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisActionPerformed
        ...
        String branch = "Lippo Mall Puri";

        Regis r = new Regis();
        r.regisAction(name, mobile, gender, ranks, dob, branch, "puri");
    ...
    private void EditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseClicked
        ...
        Edit e = new Edit();
        e.editAction(name, mobile, gender, ranks, dob, id, "puri");
    ...
    private void group_txtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_group_txtActionPerformed
        ...
        {
         String select = "Select * from holly_registration.puri WHERE Ranks = \"Staff\"";
         updateTable(select);
        }
        else if(group == "Member")
        {
         String select = "Select * from holly_registration.puri WHERE Ranks = \"Customer\"";
         updateTable(select);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LippoPuri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
