...
public class Ambassador extends javax.swing.JFrame {

    public Ambassador() {
        initComponents();
        setDefaultCloseOperation(Ambassador.DISPOSE_ON_CLOSE);
        updateTable("Select * from holly_registration.ambassador");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mall Ambassador");
...
//Performing the Registration    
    private void RegisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisActionPerformed
        ...
        String branch = "Mall Ambassador";

        Regis r = new Regis();
        r.regisAction(name, mobile, gender, ranks, dob, branch, "ambassador");
    ...
    private void EditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseClicked
        ...
        Edit e = new Edit();
        e.editAction(name, mobile, gender, ranks, dob, id,  "ambassador");
    ...
    private void group_txtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_group_txtActionPerformed
        ...
        {
         String select = "Select * from holly_registration.ambassador WHERE Ranks = \"Staff\"";
         updateTable(select);
        }
        else if(group == "Member")
        {
         String select = "Select * from holly_registration.ambassador WHERE Ranks = \"Customer\"";
         updateTable(select);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ambassador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ambassador().setVisible(true);
            }
        });
    }
