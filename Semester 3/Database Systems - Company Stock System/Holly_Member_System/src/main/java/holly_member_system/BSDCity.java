...
public class BSDCity extends javax.swing.JFrame {

    public BSDCity() {
        initComponents();
        setDefaultCloseOperation(Ambassador.DISPOSE_ON_CLOSE);
        updateTable("Select * from holly_registration.bsd");
    }
...
//Printing out to display
    private void updateTable(String Select){
        ...
        try {
            ...
            Logger.getLogger(BSDCity.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//Performing the Registration    
    private void RegisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisActionPerformed
        ...
        String branch = "BSD City";

        Regis r = new Regis();
        r.regisAction(name, mobile, gender, ranks, dob, branch, "bsd");
    ...
    private void EditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseClicked
        ...
        Edit e = new Edit();
        e.editAction(name, mobile, gender, ranks, dob, id, "bsd");
    ...
    private void group_txtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_group_txtActionPerformed
        ...
        {
         String select = "Select * from holly_registration.bsd WHERE Ranks = \"Staff\"";
         updateTable(select);
        }
        else if(group == "Member")
        {
         String select = "Select * from holly_registration.bsd WHERE Ranks = \"Customer\"";
         updateTable(select);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BSDCity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
